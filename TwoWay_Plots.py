...
Bp_rules[('A','Top Primary Member')]    = {'Bpmin':1.00,  'zwzha':0.20, 'zwzhb':0.60, 'xp':0.60, 'xs':1.15}
Bp_rules[('A','Secondary Members')]     = {'Bpmin':1.00,  'zwzha':0.20, 'zwzhb':0.20, 'xp':0.55, 'xs':1.00}
...
Bp_rules[('C','Secondary Member 2')]    = {'Bpmin':None,  'zwzha':None, 'zwzhb':0.00, 'xp':0.65, 'xs':0.80}
Bp_rules[('D','Primary Members')]       = {'Bpmin':'Bp0', 'zwzha':0.00, 'zwzhb':0.85, 'xp':1.00, 'xs':0.85}
Bp_rules[('D','Secondary Member 1')]    = {'Bpmin':None,  'zwzha':None, 'zwzhb':0.00, 'xp':0.35, 'xs':0.95}    
Bp_rules[('E','Top Primary Member')]    = {'Bpmin':0.25,  'zwzha':0.25, 'zwzhb':0.90, 'xp':1.15, 'xs':1.05}
Bp_rules[('E','Bottom Primary Member')] = {'Bpmin':0.20,  'zwzha':0.20, 'zwzhb':0.65, 'xp':1.00, 'xs':0.85}
Bp_rules[('E','Secondary Member 1')]    = {'Bpmin':None,  'zwzha':None, 'zwzhb':0.00, 'xp':0.35, 'xs':0.95}
Bp_rules[('F','Top Primary Member')]    = {'Bpmin':'Bp0', 'zwzha':0.00, 'zwzhb':0.60, 'xp':0.65, 'xs':0.80}
Bp_rules[('F','Secondary Member 2')]    = {'Bpmin':None,  'zwzha':None, 'zwzhb':0.00, 'xp':0.35, 'xs':0.95}
